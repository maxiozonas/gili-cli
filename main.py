...
from src.processors import RFMProcessor, MarketingScorer
from src.connectors import GoogleSheetsUploader, GoogleMerchantFeed, FlexxusSync
from src.utils import setup_file_logging, get_logger, parse_comma_decimal
from src.operations import run_manual_update, run_monthly_report, run_export_category
...
def rfm(
    ...
    try:
        ...
        console.print(f"[green]Datos obtenidos:[/green]")
        ...
        console.print(f"  - Calculando metricas RFM...")
...
def sync(
    ...
    try:
        ...
        console.print(f"[bold green]Sincronizacion completada![/bold green]")
...
def merchant(
    ...
    try:
        ...
        console.print(f"[bold green]Feed generado exitosamente![/bold green]")
...
def qr(
    ...
    try:
        ...
        if result["success"]:
            console.print(f"[bold green]Exportacion completada![/bold green]")
...
def manual_update(
    ...
    try:
        ...
        if result["dry_run"]:
            ...
            if result["success"]:
                console.print(f"[bold green]Actualizacion completada![/bold green]")
    ...
    try:
        ...
        if result["success"]:
            if result.get("products_count", 0) > 0:
                console.print(f"[bold green]Reporte generado![/bold green]")
